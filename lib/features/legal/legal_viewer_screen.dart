...
<ul>
  <li><strong>Urge logs</strong> -- trigger categories, timestamps, and optional notes</li>
  <li><strong>Lapse logs</strong> -- guided reflection responses (what happened, what triggered it, what you learned, what to do next time)</li>
  <li><strong>Reflection entries</strong> -- mood ratings and free-text journal entries</li>
  <li><strong>Personal values</strong> -- your selected core values (up to 3)</li>
  <li><strong>First name</strong> -- used only for personalising the app locally</li>
  <li><strong>App preferences</strong> -- guarded app selections and settings</li>
  <li><strong>Date of birth and gender (optional)</strong> -- provided during onboarding for age verification and app personalisation. Stored locally on your device only.</li>
</ul>
...
<ul>
  <li><strong>Anonymous user ID (UUID)</strong> -- a randomly generated identifier with no connection to your real identity</li>
  <li><strong>Streak data</strong> -- your current streak count and start date</li>
  <li><strong>Accountability partner details</strong> -- if you add a partner, their name and email are stored in Firestore to enable weekly progress reports</li>
</ul>
...
<ul>
  ...
  <li><strong>VPN active status</strong> (boolean -- whether the content filter is running)</li>
  <li><strong>Guard service active status</strong> (boolean -- whether the app guard is running)</li>
</ul>
...
<ul>
  <li><strong>SendGrid</strong> -- sends accountability emails (weekly reports, partner invitations, and protection alerts). Processes the recipient email and report content (streak data only, never urge/lapse details).</li>
  <li><strong>RevenueCat</strong> -- processes subscriptions through Google Play. We receive subscription status but never payment card details.</li>
</ul>
...
<ul>
  ...
  <li>Send accountability alerts when protection is interrupted (warm, non-shaming check-in prompts -- never details about what was accessed)</li>
...
<p>ANCHORAGE uses a local VPN service to filter DNS requests entirely on your device. No browsing data, DNS queries, or network traffic is transmitted to our servers. Your actual internet traffic is not intercepted or proxied. The VPN only routes DNS queries through a local resolver -- all other traffic bypasses the VPN entirely.</p>

<h2>5. Data Retention</h2>
<ul>
  <li><strong>Local data</strong> -- retained until you clear app data, uninstall, or sign out</li>
  <li><strong>Firebase data</strong> -- retained while your anonymous account exists; deleted within 30 days upon request</li>
  <li><strong>Heartbeat data</strong> -- only the most recent heartbeat is stored; older heartbeats are overwritten</li>
  <li><strong>SendGrid</strong> -- email delivery logs retained per SendGrid policy (typically 30 days)</li>
  <li><strong>RevenueCat</strong> -- subscription records retained per RevenueCat policy and Google Play requirements</li>
</ul>
...
<ul>
  ...
  <li><strong>Deletion</strong> -- request deletion of all your data</li>
...
<div class="warning-box">
  <p><strong>Important:</strong> ANCHORAGE is a self-help tool. It is not a mental health service.</p>
</div>
...
<ul>
  ...
  <li>Reports contain only general progress data (streak count, milestones) -- never urge logs, reflections, or browsing data</li>
